...
primitiveTypeArray.forEach((n)=>console.log(`Value: ${n}`, "Type:", typeof n));
for(let i = 0; i < primitiveTypeArray.length; i++)console.log(`Value: ${primitiveTypeArray[i]}`, "Type:", typeof primitiveTypeArray[i]);
i = 0;
while(i < primitiveTypeArray.length){
    console.log(`Value: ${primitiveTypeArray[i]}`, "Type:", typeof primitiveTypeArray[i]);
    i++;
}
i = 0;
do {
...
if (Object.hasOwn(person, "occupation")) console.log("Person has job");
else console.log("Person is umemployed");
